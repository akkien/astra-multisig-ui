	...
	export class BaseAccount extends pb_1.Message {
		...
		get pub_key() {
			return pb_1.Message.getWrapperField(
				this,
				dependency_3.google.protobuf.Any,
				2
			) as dependency_3.google.protobuf.Any;
		}
		...
		serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
			...
			if (this.pub_key !== undefined) writer.writeMessage(2, this.pub_key, () => this.pub_key.serialize(writer));
			...
			while (reader.nextField()) {
				...
				switch (reader.getFieldNumber()) {
					...
					case 2:
						reader.readMessage(
							message.pub_key,
							() => (message.pub_key = dependency_3.google.protobuf.Any.deserialize(reader))
						);
						break;
					case 3:
