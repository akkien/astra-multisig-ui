	...
	export class EthAccount extends pb_1.Message {
		...
		get base_account() {
			return pb_1.Message.getWrapperField(
				this,
				dependency_1.cosmos.auth.v1beta1.BaseAccount,
				1
			) as dependency_1.cosmos.auth.v1beta1.BaseAccount;
		}
				...
				switch (reader.getFieldNumber()) {
					case 1:
						reader.readMessage(
							...
							() => (message.base_account = dependency_1.cosmos.auth.v1beta1.BaseAccount.deserialize(reader))
						);
						break;
					case 2:
